...
//=============================================================================
 /*:ja
 * @plugindesc v1.01 ゲームパッド向けにボタン設定を行なうプラグインです。
 * @author Yanfly Engine Plugins
 *
 * @param Command Name
 ...
 * @param OK Help
 * @desc OKボタンのヘルプ
 * @default メニューの決定/人に話しかける際に使うボタン
 *
 * @param Cancel Button
 * @desc キャンセルボタン
 * @desc キャンセルボタンのコマンド名
 ...
 * @param Menu Help
 * @desc メニューボタンのヘルプ
 * @default フィールドからメインメニューを表示
 *
 * @param PageUp Button
 * @desc ページアップボタンのコマンド名
 * @default ページアップ
 *
 * @param PageUp Help
 * @desc ページアップボタンのヘルプ
 ...
 *
 * @param Reset Default
 * @desc 設定をリセットする際のコマンド名
 * @default 設定をリセット
 *
 * @param Reset Help
 * @desc リセットボタンのヘルプ
 * @default コントローラ設定をデフォルトへ
 *
 * @param Finish Config
 * @desc 設定を完了する際のコマンド名
 * @default 設定完了
 ...
 *
 * ゲームパッドが使用される場合、
 * "Gamepad Config"をオプションメニューに追加します。
 * プレイヤーは好みの設定設定を行うことができ、
